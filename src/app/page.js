...
const Assets = ()=>{
  return (
    <a-assets>
      {/*A5905S*/}
      <a-asset-items id="base" src="DoosanA0509S_base.gltf" ></a-asset-items>
      <a-asset-items id="j0" src="DoosanA0509S_j0.gltf" ></a-asset-items>
      <a-asset-items id="j1" src="DoosanA0509S_j1.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="DoosanA0509S_j2.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="DoosanA0509S_j3.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="DoosanA0509S_j4.gltf" ></a-asset-items>
    </a-assets>
  )
}
...
const A5905S = (props)=>{
  ...
  return (<>{visible?
    <a-entity gltf-model="#base" position="0 0 0" rotation={`0 0 0`}>
      <a-entity gltf-model="#j0" position="0 0.155 0" rotation={`0 ${j1_rotate} 0`}>
        <a-entity gltf-model="#j1" position="0 0 0" rotation={`0 0 ${j2_rotate}`}>
          <a-entity gltf-model="#j2" position="0 0.4088 0" rotation={`0 0 ${j3_rotate}`}>
            <a-entity gltf-model="#j3" position="0 0.3671 0" rotation={`0 0 ${j4_rotate}`}>
              <a-entity gltf-model="#j4" position="0 0.099 0" rotation={`0 ${j5_rotate} 0`}>
              </a-entity>
            </a-entity>
          </a-entity>
        </a-entity>
...
const Select_Robot = (props)=>{
  ...
  return (<>
    <A5905S visible={visibletable[0]} {...rotateProps}/>
  </>)
}
